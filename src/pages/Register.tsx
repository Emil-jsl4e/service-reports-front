            ...
            <main className="form-signin">
                <form onSubmit={submit}>
                    ...
                    <div className="form-floating">
                        <input className="form-control" placeholder="First name" onChange={e => firstName = e.target.value}/>
                        <label>First name</label>
                    </div>

                    <div className="form-floating">
                        <input className="form-control" placeholder="Last name" onChange={e => lastName = e.target.value}/>
                    ...
                    <div className="form-floating">
                        <input type="password" className="form-control" placeholder="Password Confirm" onChange={e => passwordConfirm = e.target.value}/>
